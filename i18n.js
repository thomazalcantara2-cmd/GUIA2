...
(() => {
  ...
  const T = {
    ...
    'Tem vagas para todos os hóspedes?': { en: 'Is there parking for all guests?', es: '¿Hay plazas para todos los huéspedes?' },
    'O estacionamento do subsolo possui 18 vagas': { en: 'The basement parking lot has 18', es: 'El estacionamiento del subsuelo posee 18 plazas' },
    'ROTATIVAS': { en: 'ROTATING', es: 'ROTATIVAS' },
    ', disponíveis,': { en: 'spaces, available,', es: ', disponibles,' },
    'SEM CUSTO': { en: 'AT NO COST', es: 'SIN COSTO' },
    ', conforme a ocupação. Não há vagas fixas ou reservadas.': { en: ', depending on occupancy. There are no fixed or reserved spaces.', es: ', según la ocupación. No hay plazas fijas ni reservadas.' },
    'Como acessar pela primeira vez?': { en: 'How do I access it for the first time?', es: '¿Cómo acceder por primera vez?' },
    ...
    'E se o porteiro estiver ausente?': { en: 'What if the doorman is away?', es: '¿Y si el portero está ausente?' },
    'Acesse o flat que dispões do controle remoto na prateleira da sala.': { en: 'Access the flat, which has the remote control on the living room shelf.', es: 'Accede al flat, que dispone del control remoto en el estante de la sala.' },
    ...
    'Traslados aeroporto/hotel e passeios.': { en: 'Airport/hotel transfers and tours.', es: 'Traslados aeropuerto/hotel y paseos.' },
