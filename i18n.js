...
(() => {
  ...
  const T = {
    ...
    'O empreendimento dispõe de': { en: 'The property has', es: 'El emprendimiento cuenta con' },
    '18 vagas': { en: '18 parking spaces', es: '18 plazas' },
    'de estacionamento no subsolo, destinadas ao uso': { en: 'in the basement, for', es: 'de estacionamiento en el subsuelo, destinadas al uso' },
    'rotativo': { en: 'rotating use', es: 'rotativo' },
    'dos hóspedes,': { en: 'by guests,', es: 'de los huéspedes,' },
